...
public enum ErrorCode {
    ...
    PASSWORD_WRONG(10017, "Incorrect current password", HttpStatus.BAD_REQUEST),
    PASSWORD_NOT_SAME(10018, "New password and confirmation password do not match", HttpStatus.BAD_REQUEST),
